        ...
        <tbody>
          ...
          ?><tr>
                ...
                <td class="d-flex justify-content-between">
                  <a href="<?php echo(ADMIN."administrador/atualiza/".$l['nId']); ?>" class="btn btn-primary ml-auto m-1">Atualizar</a>
                  <a href="#" style="width: 30%;" class="btn btn-danger ml-auto m-1 delError" onclick="AdminDel('<?php echo ($l['nId']); ?>','<?php echo ($l['wLogin']); ?>','<?php echo ($l['wNome']); ?>');">Excluir</a>
                  <a href="<?php echo(ADMIN."administrador/acesso/".$l['nId']); ?>" style="width: 30%;" type="button" class="btn btn-success ml-auto m-1 delError">Acessos</a>
                </td>
              </tr>
          <?php
            } // ENDWHILE
